...
public class JSpecTest {
    ...
    private fun assertStartDescriptions(descriptions: List<Description>) {
        ...
        assertEquals("org.spek.impl.junit.MySpek", descriptions.get(0).toString())
    ...
    private fun assertFinishDescriptions(descriptions: List<Description>) {
        ...
        assertEquals("org.spek.impl.junit.MySpek", descriptions.get(4).toString())
    }
}

class MySpek: AbstractSpek() {{
    given("a situation") {
