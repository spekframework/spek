...
import org.spek.impl.console.reflect.*
import org.spek.api.skip

public class SpecificationRunner(val listener: Listener) {
    private val BASE_CLASS = javaClass<AbstractSpek>()
    fun runSpecs(packageName: String) {
        ...
        classes forEach { specificationClass ->
            ...
            */
            ...
            if (!skipped) {
                val givenActions = (specificationClass.newInstance() as AbstractSpek).allGivens()
