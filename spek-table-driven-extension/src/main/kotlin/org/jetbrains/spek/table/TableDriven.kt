...
fun <T> Spec.unroll(vararg testCases: TestCase<T>, function: TestContainer.(T) -> Unit) {
    testCases.forEach { function.invoke(this, it.value) }
}

fun <A, B> Spec.unroll(vararg testCases: TestCase2<A, B>, function: TestContainer.(A, B) -> Unit) {
