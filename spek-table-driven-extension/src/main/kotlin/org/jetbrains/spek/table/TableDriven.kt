...
@Experimental
fun <P1> Spec.forEvery(vararg examples: Example1<P1>, testContent: TestContainer.(P1) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
            }
        }
...
@Experimental
fun <P1, P2> Spec.forEvery(vararg examples: Example2<P1, P2>, testContent: TestContainer.(P1, P2) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3> Spec.forEvery(vararg examples: Example3<P1, P2, P3>, testContent: TestContainer.(P1, P2, P3) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4> Spec.forEvery(vararg examples: Example4<P1, P2, P3, P4>, testContent: TestContainer.(P1, P2, P3, P4) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5> Spec.forEvery(vararg examples: Example5<P1, P2, P3, P4, P5>, testContent: TestContainer.(P1, P2, P3, P4, P5) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6> Spec.forEvery(vararg examples: Example6<P1, P2, P3, P4, P5, P6>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7> Spec.forEvery(vararg examples: Example7<P1, P2, P3, P4, P5, P6, P7>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8> Spec.forEvery(vararg examples: Example8<P1, P2, P3, P4, P5, P6, P7, P8>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9> Spec.forEvery(vararg examples: Example9<P1, P2, P3, P4, P5, P6, P7, P8, P9>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> Spec.forEvery(vararg examples: Example10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> Spec.forEvery(vararg examples: Example11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> Spec.forEvery(vararg examples: Example12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> Spec.forEvery(vararg examples: Example13<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> Spec.forEvery(vararg examples: Example14<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15> Spec.forEvery(vararg examples: Example15<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16> Spec.forEvery(vararg examples: Example16<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17> Spec.forEvery(vararg examples: Example17<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18> Spec.forEvery(vararg examples: Example18<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19> Spec.forEvery(vararg examples: Example19<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20> Spec.forEvery(vararg examples: Example20<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
...
@Experimental
fun <P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21> Spec.forEvery(vararg examples: Example21<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21>, testContent: TestContainer.(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21) -> Unit) {
    examples.forEach {
        val proxyContainer = object : TestContainer by this@forEvery {
            override fun test(description: String, pending: Pending, body: TestBody.() -> Unit) {
                this@forEvery.test("$description ($it)",pending,body)
